...
namespace OpenIso8583Net.Tests.TermAppIso
{
    ...
    public class SecurityInfoFieldTests
    {
        ...
        {
            IFieldDescriptor fd = new FieldDescriptor(new VariableLengthFormatter(2, 96, Formatters.Ascii), FieldValidators.Hex, Formatters.Binary, null!);
        ...
        public void TestMessagePack()
        {
            ...
            msg.MessageType = 1200; // Iso8583Rev93.MsgType._1200_TRAN_REQ;
