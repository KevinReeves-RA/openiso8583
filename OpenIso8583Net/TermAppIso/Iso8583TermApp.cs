    ...
    public class Iso8583TermApp : Iso8583Rev93
    {
        ...
        protected override IField CreateField(int field)
        {
            if (field == Iso8583TermApp.Bit._048_PRIVATE_ADDITIONAL_DATA)
                return new AdditionalData(Template.MsgTypeFormatter);

            // I'm certain that TermApp.ISO in Postilion is broken when it comes to MAC-ing.  Using the 'B' format
        ...
        public HashtableMessage StructuredData
        {
            get
            {
                ...
                if (AdditionalData == null || !AdditionalData.ContainsKey(AdditionalData.Field.StructuredData))
                    return new HashtableMessage();
            ...
            set
            {
                ...
                {
                    AdditionalData = new AdditionalData(Template.MsgTypeFormatter);
                }
        ...
        public override int Unpack(byte[] msg, int startingOffset)
        {
            ...
            if (ascii)
                Template = GetDefaultAsciiTemplate();
            else
                Template = GetDefaultBinaryTemplate();
        ...
        protected static Template GetDefaultBinaryTemplate()
        {
            var res = new Template
                {
                    ...
                    { Bit._053_SECURITY_INFO, new FieldDescriptor(new VariableLengthFormatter(2, 96, Formatters.Ascii), FieldValidators.Hex, Formatters.Binary, null) },
            ...
            res.BitmapFormatter = Formatters.Binary;
            return res;
        }

        protected static Template GetDefaultAsciiTemplate()
        {
            var res = GetDefaultBinaryTemplate();
            res[Bit._052_PIN_DATA] = FieldDescriptor.AsciiFixed(16, FieldValidators.Hex);
            res.BitmapFormatter = Formatters.Ascii;
            return res;
        }
    }
}
