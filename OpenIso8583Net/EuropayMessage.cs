namespace OpenIso8583Net
{
    ...
    public class EuropayMessage : Iso8583
    {
        ...
        public EuropayMessage()
            : base(GetDefaultEuropayTemplate())
        {
        }
        ...
        public static class Type
        {
            ...
            public const int M0000InvalidMessage = 0;
            ...
            {
                return messageType - (messageType % 2) + 0x10;
            }
        }
        ...
        protected static Template GetDefaultEuropayTemplate()
        {
            return new Template
            {
                    {Fld.F002PrimaryAccountNumber,              FD.PanMask(FD.AsciiLlNumeric(19), "PAN")},
